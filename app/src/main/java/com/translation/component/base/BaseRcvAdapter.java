...
import com.translation.androidlib.utils.WindowUtil;
        ...
        if (holder instanceof EmptyViewHolder) {
            ...
            if (isFirst || !isEmptyViewVisible) {
                ...
                if (emptyViewMarginTop == 0){
                    eHolder.emptyLl.setPadding(0, WindowUtil.dp2px(getContext(), 125), 0, 0);
                }else {
                    eHolder.emptyLl.setPadding(0, WindowUtil.dp2px(getContext(), emptyViewMarginTop), 0, 0);
                }
            }
